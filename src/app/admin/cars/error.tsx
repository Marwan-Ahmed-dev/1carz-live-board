...
import { AlertCircle, RefreshCw, ListChecks } from 'lucide-react';
import { useRouter } from 'next/navigation';
import { logger } from '@/lib/logger';

export default function AdminCarsListError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error('[AdminCarsList Error Boundary]', error);
  }, [error]);
